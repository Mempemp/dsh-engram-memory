...
`
    ...
    function Section() {
      ...
      const connectionRows = [
        ...
        jsx('div', { className: 'pem-row', key: 'binary', children: [
        ...
        jsx('div', { className: 'pem-row', key: 'project', children: [
          jsx('span', { children: 'Проект' }),
          jsx('span', { title: state.workspace ?? '', children: state.project ?? '—' })
        ] })
      ]
      ...
      return jsxs('div', { className: 'pem-root', children: [
        ...
        jsxs(Card, {
          ...
          children: [
            ...connectionRows,
            jsx('p', { className: 'pem-muted', children: 'Память работает и без MCP: правила, подача и запись идут через плагин. MCP даёт модели поиск по памяти своими инструментами.' }),
