...
const ENTRIES = [
  ...
  ['Выгрузка объектов test-project', 'В test-project выгрузка объектов идёт пообъектно, без ConfigDumpInfo.xml'],
...
const QUERIES = [
  ...
  ['падеж', 'выгрузка объектов из test-project', 'Выгрузка объектов test-project'],
  ['словообразование', 'каталожные файлы компонентов', 'Каталог компонентов бандла'],
  ['словообразование', 'выгрузить объекты test-project', 'Выгрузка объектов test-project'],
  ...
  ['идентификатор', 'test-project configdumpinfo', 'Выгрузка объектов test-project'],
